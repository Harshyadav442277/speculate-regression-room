export function regressionScript(artifact) {
...
// Captured fixture: ${artifact.configuration.fixture}; run mode: ${artifact.execution}.
...
export function markdownReport(artifact) {
