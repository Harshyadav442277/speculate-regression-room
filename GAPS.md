...
| P1 | Demo recording and judge access absent | Fresh GitHub clone/install/build/export checks passed; backup ownership is verified as Harshyadav442277; repository is private and no video is verified | Verify repository/video links from the intended judge account and submit |
